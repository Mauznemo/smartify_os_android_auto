...
- Needs `android_auto` 0.1.5 or newer, for `hasVideo`. 0.1.4 is the first to measure the view right inside SmartifyOS's scaled design canvas; older ones make the picture soft.
